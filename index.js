...
// Given the name of the department, what is the department's id?
...
// Given the name of the role, what is the role's id?
...
async function getEmployeeId(fullName) {
    // Split employee's name into first name and last name
...
function getFirstAndLastName( fullName ) {
    // If a person has a space in their first name, 
...
async function updateEmployeeRole(employeeInfo) {
    // Given the name of the role, what is the role's id?
    // Given full name of the employee, what is their first_name and last_name?
    // UPDATE employee SET role_id=1 WHERE employee.first_name='John' AND employee.last_name='Doe';
...
async function mainPrompt() {
    return inquirer
        .prompt([
            {
                type: "list",
                message: "What is this purpose for employee management?",
                name: "action",
                choices: [
                  "Add department",
                  "Add employee",
...
async function getDepartmentInfo() {
    ...
    .prompt([
        {
            type: "input",
            message: "What is the name of the department you want to inquiry?",
            name: "departmentName"
        }
    ])
}
...
async function getUpdateEmployeeRoleInfo() {
    ...
    return inquirer
        .prompt([
            {
                type: "list",
                message: "What is the name of employee do you want to update?",
                name: "employeeName",
                choices: [
                    // populate from db
                    ...employees
...
async function main() {
    ...
    while(!exitLoop) {
        ...
        switch(prompt.action) {
            ...
            default:
                console.log(`Internal warning. Anything wrong? action was ${prompt.action}`);
        }
    }
}
...
process.on("exit", async function(code) {
    await db.close();
    return console.log(`Nearly exit with code ${code}`);
});
